...
const UpdateOrderForm = () => {
  ...
  const changeFormDataToOrder = (obj) => {
    return {
      ...
      restaurantId:
        obj.restaurantId === "" ? orders.restaurantId : obj.restaurantId,
      driverNote: obj.driverNote === "" ? orders.driverNote : obj.driverNote,
      address: obj.address === "" ? orders.address : obj.address,
      orderTime: {
        orderPlaced:
          obj.orderPlaced === ""
            ? orders.orderTime.orderPlaced
            : obj.orderPlaced,
        restaurantAccept:
          obj.restaurantAccept === ""
            ? orders.orderTime.restaurantAccept
            : obj.restaurantAccept,
        restaurantStart:
          obj.restaurantStart === ""
            ? orders.orderTime.restaurantStart
            : obj.restaurantStart,
        restaurantComplete:
          obj.restaurantComplete === ""
            ? orders.orderTime.restaurantComplete
            : obj.restaurantComplete,
        driverAccept:
          obj.driverAccept === ""
            ? orders.orderTime.driverAccept
            : obj.driverAccept,
        delivered:
          obj.delivered === "" ? orders.orderTime.delivered : obj.delivered,
        deliverySlot:
          obj.deliverySlot === ""
            ? orders.orderTime.deliverySlot
            : obj.deliverySlot,
      },
